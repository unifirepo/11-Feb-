        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600 space-y-2">
              <p>
                <a href="mailto:info@unifi.id" className="hover:text-gray-900 transition-colors">
                  info@unifi.id
                </a>
              </p>
              <p>
                <a href="tel:+447785996916" className="hover:text-gray-900 transition-colors">
                  +44 (0) 7785 996 916
                </a>
              </p>
              <div className="pt-2 space-y-1">
                ...
                <p>
                  <Link href="/modern-slavery" className="hover:text-gray-900 transition-colors">
